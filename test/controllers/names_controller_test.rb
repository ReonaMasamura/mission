...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { first-name: @name.first-name, second-name: @name.second-name } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { first-name: @name.first-name, second-name: @name.second-name } }
